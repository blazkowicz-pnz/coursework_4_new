...
class MovieModel(BaseMixin, db.Model):
    ...
    genre_id = db.Column(db.Integer, db.ForeignKey(GenreModel.id), nullable=False)
    director_id = db.Column(db.Integer, db.ForeignKey(DirectorModel.id), nullable=False)
